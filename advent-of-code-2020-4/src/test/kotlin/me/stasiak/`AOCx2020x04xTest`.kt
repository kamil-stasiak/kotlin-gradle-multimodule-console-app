...
sealed class Field(
    ...
    class Hgt(value: String) : Field(value = value) {
        override fun isValid(): Boolean {
            ...
            return when {
                ...
                value.endsWith("cm") -> value.substringBefore("cm").toIntOrNull() in (150..193)
                // If in, the number must be at least 59 and at most 76.
                value.endsWith("in") -> value.substringBefore("in").toIntOrNull() in (59..76)
                else -> false
            }
        }
    }
    ...
    class Pid(value: String) : Field(value = value) {
        override fun isValid(): Boolean {
            ...
            Integer.MAX_VALUE
            return number != null && value.length == 9
        }
    }
...
iyr:2011 ecl:brn hgt:59in
        ...
        val result = input
            .map { it.replace("\n", " ") } // every line
            .filter { passport -> requiredFileds.all { fieldName -> passport.contains(fieldName) } }
